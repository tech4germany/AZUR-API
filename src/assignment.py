...
def dhondt(votes: Mapping[str, int], seats_available: int, return_table: bool = False) -> Tuple[Dict[str, int], List[str], List[List[int]]]:
    ...
    the table of distributions from one seat up to the final one as a tuple with (a) the headers and (b) the values of the table
    """
    
    return assign_iterative(votes, seats_available, 1, return_table)

def schepers(votes: Mapping[str, int], seats_available: int, return_table: bool) -> Tuple[Dict[str, int], List[str], Tuple[List[str], List[List[int]]]]:
...
def assign_iterative(votes: Mapping[str, int], seats_available: int, div_starting_val: int = 1, return_table: bool = False) -> Tuple[Dict[str, int], List[str], Tuple[List[str], List[List[int]]]]: #TODO typing
